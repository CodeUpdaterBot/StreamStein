...
function injectTitlebar() {
  if (document.getElementById("__streamstein_titlebar__")) return;

  // -- Bar -------------------------------------------------------------------
  const bar = document.createElement("div");
  bar.id = "__streamstein_titlebar__";
  css(bar, {
    position: "fixed",
    top: "0",
    left: "0",
  ...
  sensor.id = "__streamstein_sensor__";
  css(sensor, {
    position: "fixed",
    top: "0",
    left: "0",
