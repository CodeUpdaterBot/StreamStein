...
export default function CastMiniController({ cast, variant = "player" }) {
  ...
  const handleScrubChange = (e) =>
    setDrag((Number(e.target.value) / 100) * duration);
  ...
  const isBuffering =
    sessionState === "buffering" || sessionState === "connecting";
  ...
  return (
    <div style={containerStyle}>
      ...
      >
        <div
          style={{ maxWidth: variant === "global" ? "none" : 180, flexShrink: 0 }}
        >
          {deviceLabel}
        </div>
        {playPauseBtn}
