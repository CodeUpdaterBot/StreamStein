...
export default function DownloadsPage({
  ...
  const handleScanFolder = useCallback(async () => {
    ...
    try {
      ...
      storage.set(STORAGE_KEYS.LOCAL_FILES, unique);
      window.dispatchEvent(new CustomEvent(LOCAL_FILES_CHANGED));
      ...
      <div className="dl-card__row">
        ...
        <div className="dl-card__body">
          ...
          <div className="dl-card__meta">
            ...
            {isError && dl.lastMessage && (
              <span
                className="dl-card__error-msg"
                title={dl.lastMessage}
              >
                {dl.lastMessage}
              </span>
            )}
